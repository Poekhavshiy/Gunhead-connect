...
template <> constexpr inline auto SettingsWindow::qt_create_metaobjectdata<qt_meta_tag_ZN14SettingsWindowE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        ...
        "savePath",
        "saveApiKey",
        "toggleLanguageSelectWindow",
        "toggleThemeSelectWindow"
    };
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'toggleLanguageSelectWindow'
        QtMocHelpers::SlotData<void()>(10, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'toggleThemeSelectWindow'
...
void SettingsWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->settingsChanged((*reinterpret_cast< std::add_pointer_t<Theme>>(_a[1]))); break;
        case 1: _t->toggleUpdateCheck((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        case 2: _t->updatePath(); break;
        case 3: _t->savePath(); break;
        case 4: _t->saveApiKey(); break;
        case 5: _t->toggleLanguageSelectWindow(); break;
        case 6: _t->toggleThemeSelectWindow(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (SettingsWindow::*)(Theme )>(_a, &SettingsWindow::settingsChanged, 0))
            return;
    }
}
...
// SIGNAL 0
void SettingsWindow::settingsChanged(Theme _t1)
{
